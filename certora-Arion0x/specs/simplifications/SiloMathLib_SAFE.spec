methods {
    ...
    function SiloMathLib.liquidity(uint256 _collateralAssets, uint256 _debtAssets) internal returns (uint256) => liquidityCVL(_collateralAssets,_debtAssets);
...
function liquidityCVL(uint256 collateralAssets, uint256 debtAssets)returns uint256 {
    uint256 liquidity;
    liquidity = debtAssets > collateralAssets ? 0 : require_uint256(collateralAssets - debtAssets);
    return liquidity;
}