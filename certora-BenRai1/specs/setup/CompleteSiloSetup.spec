...
// invariant totalSuppliesMoreThanBalance_token0(address user)               token0.totalSupply() >= token0.balanceOf(user);
// invariant totalSuppliesMoreThanBalance_shareProtectedToken0(address user) shareProtectedCollateralToken0.totalSupply() >= shareProtectedCollateralToken0.balanceOf(user);
// invariant totalSuppliesMoreThanBalance_shareDebtToken0(address user)      shareDebtToken0.totalSupply() >= shareDebtToken0.balanceOf(user);
// invariant totalSuppliesMoreThanBalance_siloToken0(address user)           silo0.totalSupply() >= silo0.balanceOf(user);
// invariant totalSuppliesMoreThanBalance_token1(address user)               token1.totalSupply() >= token1.balanceOf(user);
// invariant totalSuppliesMoreThanBalance_shareProtectedToken1(address user) shareProtectedCollateralToken1.totalSupply() >= shareProtectedCollateralToken1.balanceOf(user);
// invariant totalSuppliesMoreThanBalance_shareDebtToken1(address user)      shareDebtToken1.totalSupply() >= shareDebtToken1.balanceOf(user);
// invariant totalSuppliesMoreThanBalance_siloToken1(address user)           silo1.totalSupply() >= silo1.balanceOf(user);

// // total supply is more than balance - 2 users
// invariant totalSuppliesMoreThanBalance2_token0(address user0, address user1)
//     user0 != user1 => token0.totalSupply() >= require_uint256(token0.balanceOf(user0) + token0.balanceOf(user1));
// invariant totalSuppliesMoreThanBalance2_shareProtectedToken0(address user0, address user1)
...
// invariant totalSuppliesMoreThanBalance2_shareDebtToken0(address user0, address user1)
//     user0 != user1 => shareDebtToken0.totalSupply() >= require_uint256(shareDebtToken0.balanceOf(user0) + shareDebtToken0.balanceOf(user1));
// invariant totalSuppliesMoreThanBalance2_siloToken0(address user0, address user1)
//     user0 != user1 => silo0.totalSupply() >= require_uint256(silo0.balanceOf(user0) + silo0.balanceOf(user1));
// invariant totalSuppliesMoreThanBalance2_token1(address user0, address user1)
//     user0 != user1 => token1.totalSupply() >= require_uint256(token1.balanceOf(user0) + token1.balanceOf(user1));
// invariant totalSuppliesMoreThanBalance2_shareProtectedToken1(address user0, address user1)
...
// invariant totalSuppliesMoreThanBalance2_shareDebtToken1(address user0, address user1)
//     user0 != user1 => shareDebtToken1.totalSupply() >= require_uint256(shareDebtToken1.balanceOf(user0) + shareDebtToken1.balanceOf(user1));
// invariant totalSuppliesMoreThanBalance2_siloToken1(address user0, address user1)
